IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'cfb_cp_IdsPasswordRequests')
	BEGIN
		DROP  Procedure  [dbo].[cfb_cp_IdsPasswordRequests]
	END

GO

CREATE Procedure [dbo].[cfb_cp_IdsPasswordRequests]
(
	@candidateID char(5),
...
GRANT EXEC ON [dbo].[cfb_cp_IdsPasswordRequests] TO cfis
