...
namespace Cfb.CandidatePortal.UnitTest
{
	...
	/// <summary>
	///This is a test class for CmoAttachmentHandlerTest and is intended
	///to contain all CmoAttachmentHandlerTest Unit Tests
	///</summary>
	[TestClass()]
	public class CmoAttachmentHandlerTest
	{
		...
		/// <summary>
		///A test for CmoAttachmentHandler Constructor
		///</summary>
		[TestMethod()]
