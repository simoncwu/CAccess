namespace Cfb.CandidatePortal.ServiceProcess.DataServiceHost
{
	partial class ProjectInstaller
	{
		...
		private void InitializeComponent()
		{
			...
			// serviceInstaller
			// 
			this.serviceInstaller.Description = "Provides access to C-Access data";
			this.serviceInstaller.DisplayName = "C-Access Data Service";
			this.serviceInstaller.ServiceName = "CPDataService";
