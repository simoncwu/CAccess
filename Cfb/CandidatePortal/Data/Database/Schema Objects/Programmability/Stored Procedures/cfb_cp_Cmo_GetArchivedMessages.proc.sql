/*
 * Retrieves all (posted) archived messages for a specific candidate and election cycle.
 */
CREATE PROCEDURE [dbo].[cfb_cp_Cmo_GetArchivedMessages]
(
